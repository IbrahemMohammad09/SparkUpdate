        ...
        <div className="bg-[#2c90a7] m-4 md:m-16 p-4 md:p-8 rounded-2xl">
          <div className="flex flex-col justify-start items-start gap-8 mt-12">
            {Topservices.map((service, index) => (
              <motion.div
                key={index}
                className="rounded-2xl p-6 bg-[#f1f6f9] md:p-10 flex flex-col gap-3 w-full hover:scale-105 transition-all cursor-pointer"
              ...
              >
                ...
                <div className="flex flex-col p-4">
                  <h1 className="text-2xl md:text-4xl text-[#212529] ">{service.title}</h1>
                  <Link
                    to={service.url}
